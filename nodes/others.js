/**
 * LiteGraph others nodes - ESM version
 * Converted from the original litegraph.js library
 */

/**
 * Registers others nodes with LiteGraph
 * @param {Object} LiteGraph - The LiteGraph namespace
 */
export function registerOthersNodes(LiteGraph) {
...
export default registerOthersNodes;

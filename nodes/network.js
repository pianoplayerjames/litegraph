/**
 * LiteGraph network nodes - ESM version
 * Converted from the original litegraph.js library
 */

/**
 * Registers network nodes with LiteGraph
 * @param {Object} LiteGraph - The LiteGraph namespace
 */
export function registerNetworkNodes(LiteGraph) {
...
export default registerNetworkNodes;

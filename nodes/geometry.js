/**
 * LiteGraph geometry nodes - ESM version
 * Converted from the original litegraph.js library
 */

/**
 * Registers geometry nodes with LiteGraph
...
var vec3 = (glMatrix && glMatrix.vec3) || _global.vec3 || {
    ...
    fromValues: function(x, y, z) { var out = new Float32Array(3); out[0] = x; out[1] = y; out[2] = z; return out; },
    ...
    random: function(out) { out[0] = Math.random(); out[1] = Math.random(); out[2] = Math.random(); return out; }
};
var mat4 = (glMatrix && glMatrix.mat4) || _global.mat4 || {
    create: function() { var out = new Float32Array(16); out[0] = out[5] = out[10] = out[15] = 1; return out; },
    identity: function(out) { for(var i=0;i<16;i++) out[i]=0; out[0]=out[5]=out[10]=out[15]=1; return out; },
    ...
    transpose: function(out, a) {
        if(out===a){var t;t=a[1];out[1]=a[4];out[4]=t;t=a[2];out[2]=a[8];out[8]=t;t=a[3];out[3]=a[12];out[12]=t;
        t=a[6];out[6]=a[9];out[9]=t;t=a[7];out[7]=a[13];out[13]=t;t=a[11];out[11]=a[14];out[14]=t;}
        else{out[0]=a[0];out[1]=a[4];out[2]=a[8];out[3]=a[12];out[4]=a[1];out[5]=a[5];out[6]=a[9];out[7]=a[13];
    ...
    setTranslation: function(out, v) { out[12]=v[0];out[13]=v[1];out[14]=v[2]; return out; },
    fromQuat: function(out, q) {
        var x=q[0],y=q[1],z=q[2],w=q[3];
        var x2=x+x,y2=y+y,z2=z+z,xx=x*x2,yx=y*x2,yy=y*y2,zx=z*x2,zy=z*y2,zz=z*z2,wx=w*x2,wy=w*y2,wz=w*z2;
        out[0]=1-yy-zz;out[1]=yx+wz;out[2]=zx-wy;out[3]=0;out[4]=yx-wz;out[5]=1-xx-zz;out[6]=zy+wx;out[7]=0;
        out[8]=zx+wy;out[9]=zy-wx;out[10]=1-xx-yy;out[11]=0;out[12]=0;out[13]=0;out[14]=0;out[15]=1;
        return out;
    }
};
var quat = (glMatrix && glMatrix.quat) || _global.quat || {
    create: function() { var out = new Float32Array(4); out[3] = 1; return out; },
    setAxisAngle: function(out, axis, rad) {
        var s = Math.sin(rad / 2);
        out[0] = s * axis[0]; out[1] = s * axis[1]; out[2] = s * axis[2]; out[3] = Math.cos(rad / 2);
        return out;
    }
};
...
export default registerGeometryNodes;

/**
 * LiteGraph strings nodes - ESM version
 * Converted from the original litegraph.js library
 */

/**
 * Registers strings nodes with LiteGraph
 * @param {Object} LiteGraph - The LiteGraph namespace
 */
export function registerStringsNodes(LiteGraph) {
//basic nodesfunction toString(a) {
...
export default registerStringsNodes;
